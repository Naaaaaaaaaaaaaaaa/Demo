...
namespace VehicleRentalServices
{
    public partial class DisplayRenter : Form
    {
        ...
        private void ClickSendFeedback(object sender, EventArgs e)
        {
            DisplayRenterSendFeedback displayRenterSendFeedbac = new DisplayRenterSendFeedback();
            displayRenterSendFeedbac.Show();
            this.Close();
        }
        ...
        {
            DisplayRenterContractHistory displayRenterContractHistory = new DisplayRenterContractHistory();
