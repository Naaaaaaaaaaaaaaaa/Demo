...
namespace VehicleRentalServices
{
    ...
    public class Contract
    {
        ...
        public Contract(Business business, Renter renter, Driver driver, Assistant assistant, Car car, DateTime startDate, DateTime endDate, int kilometer)
        {
            this.id = "VRSxxx";
        ...
        #region METHOD
        public void AddPrepayment(double prepayment)
        {
            try
            {
                if (prepayment >= this.percentagePrepayment * this.preSettlementValue)
                {
                    this.prepayment = prepayment;
                    this.hasTakenEffect = true;
                    this.id = Database.GenerateContractCode();
                }
                else
                {
        ...
        public void ContractPayments(DateTime paymentDate, EPayments ePayments, double money)
        {
            ...
            try
            {
                if (money >= this.afterSettlementValue - this.prepayment)
                {
                    ...
                    this.business.AddContract(this);
        ...
        {
            Console.WriteLine($"Business's Name : {this.business.BusinessName}");
