...
{
    public partial class DisplayAssistantContractHistory : Form
    {
        private Assistant assistant = new Assistant();
        public DisplayAssistantContractHistory()
        {
            InitializeComponent();
            LoadForm();
        ...
        private void LoadListView(List<Contract> input)
        {
            ...
            {
                if (contract.GetAssistant == this.assistant)
                {
        ...
        private void SelectedValueChangedAssistant(object sender, EventArgs e)
        {
            if (CheckAssistant())
            {
                this.assistant = (Assistant)comboBox1.SelectedItem;
                LoadListView(Database.contracts);
            }
        }
