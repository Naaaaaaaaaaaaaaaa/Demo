...
namespace VehicleRentalServices
{
    public class Database
    {
        ...
        static Owner aowner = new Owner("LE THUAN THIEN", "9999", new DateTime(1977, 9, 8), "0702569999");

        static Business abusiness = new Business("DEMETER", aowner);
        ...
        static Contract contract1 = new Contract(business, phamkhanhhuy, lequangduc, buithanhpphong, passengerCar1, DateTime.Now.AddDays(-3), DateTime.Now.AddDays(-2), 100);
        static Contract contract2 = new Contract(business, nguyenkieutrang, dinhquanghoang, tranngocnuong, touristCar1, DateTime.Now.AddDays(-2), DateTime.Now.AddDays(0), 100);
        static Contract contract3 = new Contract(business, luongducthoai, duongvanngoan, dinhvanhoa, selfDrivingCar1, DateTime.Now.AddDays(-1), DateTime.Now.AddDays(0), 100);
        static Contract contract4 = new Contract(business, vanductrong, duongvanngoan, tranngocnuong, transitCar3, DateTime.Now.AddDays(-2), DateTime.Now.AddDays(-1), 100);
        static Contract contract5 = new Contract(business, nguyennhuy, lequangduc, tranngocnuong, passengerCar2, DateTime.Now.AddDays(2), DateTime.Now.AddDays(3), 100);
        static Contract contract6 = new Contract(business, nguyenthutrang, dinhquanghoang, lethanhhoa, touristCar6, DateTime.Now.AddDays(1), DateTime.Now.AddDays(3), 100);
        static Contract contract7 = new Contract(business, phamkhanhhuy, duongvanngoan, buithanhpphong, selfDrivingCar3, DateTime.Now.AddDays(3), DateTime.Now.AddDays(4), 100);
        static Contract contract8 = new Contract(business, luongducthoai, nguyenducthinh, dinhvanhoa, touristCar3, DateTime.Now.AddDays(5), DateTime.Now.AddDays(5), 100);
        static Contract contract9 = new Contract(business, vanductrong, nguyenducthinh, buithanhpphong, touristCar5, DateTime.Now.AddDays(5), DateTime.Now.AddDays(7), 100);
        static Contract contract10 = new Contract(business, lengocuyen, nguyenhuutam, dothiyen, passengerCar3, DateTime.Now.AddDays(-4), DateTime.Now.AddDays(-2), 100);
        static Contract contract11 = new Contract(business, hothinguyet, hoangtrungthong, maithithuynhung, selfDrivingCar2, DateTime.Now.AddDays(1), DateTime.Now.AddDays(3), 100);
        static Contract contract12 = new Contract(business, nguyenhuutu, lequylam, nguyendangsu, transitCar1, DateTime.Now.AddDays(-2), DateTime.Now.AddDays(-1), 100);
        static Contract contract13 = new Contract(business, nguyenthiphuong, voquangvuong, nguyenvanlai, touristCar2, DateTime.Now.AddDays(4), DateTime.Now.AddDays(6), 100);
        static Contract contract14 = new Contract(business, lequangninh, nguyenthanhtien, maithithuynhung, selfDrivingCar4, DateTime.Now.AddDays(3), DateTime.Now.AddDays(5), 100);
        static Contract contract15 = new Contract(business, caoxuanduong, hoangtrungthong, dothiyen, passengerCar7, DateTime.Now.AddDays(1), DateTime.Now.AddDays(2), 100);
        static Contract contract16 = new Contract(business, phananhnguyet, hoangvantuy, nguyenminhvu, transitCar6, DateTime.Now.AddDays(7), DateTime.Now.AddDays(9), 100);
        static Contract contract17 = new Contract(business, nguyenkieutrang, lequylam, lethanhhoa, touristCar9, DateTime.Now.AddDays(4), DateTime.Now.AddDays(5), 100);
        static Contract contract18 = new Contract(business, tranvanhuyen, hoangvantuy, tranngocnuong, selfDrivingCar5, DateTime.Now.AddDays(0), DateTime.Now.AddDays(2), 100);
        static Contract contract19 = new Contract(business, dinhtiencuong, nguyenhuutam, truongthingocanh, passengerCar5, DateTime.Now.AddDays(-3), DateTime.Now.AddDays(-2), 100);
        static Contract contract20 = new Contract(business, nguyenkieutrang, nguyenthanhtien, nguyendangsu, transitCar5, DateTime.Now.AddDays(6), DateTime.Now.AddDays(8), 100);

        static Feedback feedback1 = new Feedback(phamkhanhhuy, aowner, ECategory.CommitmentInContract, ERate.Five, "The car rental experience was seamless and efficient. Highly recommended!", new DateTime(2022, 1, 1));
        static Feedback feedback2 = new Feedback(phamkhanhhuy, lequangduc, ECategory.ServiceAttitude, ERate.Four, "Great selection of cars and excellent customer service. Will definitely rent again.", new DateTime(2022, 1, 5));
        static Feedback feedback3 = new Feedback(phamkhanhhuy, nguyenducthinh, ECategory.ServiceAttitude, ERate.Five, "Smooth pickup and drop-off process. The vehicle was clean and well-maintained.", new DateTime(2022, 1, 7));
        static Feedback feedback4 = new Feedback(nguyenkieutrang, dinhquanghoang, ECategory.CommitmentInContract, ERate.Five, "Affordable rates and friendly staff. Made my trip hassle-free.", new DateTime(2022, 1, 10));
        static Feedback feedback5 = new Feedback(luongducthoai, duongvanngoan, ECategory.ServiceAttitude, ERate.Four, "Impressed with the professionalism of the car rental team. A positive experience overall.", new DateTime(2022, 1, 2));
        static Feedback feedback6 = new Feedback(vanductrong, dinhvanhoa, ECategory.ServiceAttitude, ERate.Five, "Quick and easy reservation process. The car exceeded my expectations.", new DateTime(2022, 1, 4));
        static Feedback feedback7 = new Feedback(nguyennhuy, tranngocnuong, ECategory.CommitmentInContract, ERate.Five, "Responsive customer support and transparent pricing. I had a stress-free rental.", new DateTime(2022, 1, 6));
        static Feedback feedback8 = new Feedback(nguyenthutrang, lethanhhoa, ECategory.ServiceAttitude, ERate.Four, "The flexibility of rental options made it convenient for my travel plans.", new DateTime(2022, 1, 14));
        static Feedback feedback9 = new Feedback(nguyenkieutrang, buithanhpphong, ECategory.ServiceAttitude, ERate.Five, "The condition of the car was excellent, and the staff was helpful and courteous.", new DateTime(2022, 1, 1));
        static Feedback feedback10 = new Feedback(hothinguyet, maithithuynhung, ECategory.ServiceAttitude, ERate.Four, "Friendly staff and good service. Car was clean and well-maintained.", new DateTime(2022, 1, 10));
        static Feedback feedback11 = new Feedback(caoxuanduong, nguyenhuutu, ECategory.CommitmentInContract, ERate.Five, "Smooth rental process and transparent pricing. Will recommend to others.", new DateTime(2022, 1, 12));
        static Feedback feedback12 = new Feedback(phananhnguyet, lequylam, ECategory.ServiceAttitude, ERate.Three, "Average service. Car condition could have been better.", new DateTime(2022, 1, 15));
        static Feedback feedback13 = new Feedback(nguyenthiphuong, dothiyen, ECategory.CommitmentInContract, ERate.Four, "Reasonable prices and good communication. Overall satisfied.", new DateTime(2022, 1, 18));
        static Feedback feedback14 = new Feedback(nguyenthanhquyet, truongthingocanh, ECategory.ServiceAttitude, ERate.Five, "Excellent service. Staff went above and beyond to assist.", new DateTime(2022, 1, 20));
        static Feedback feedback15 = new Feedback(caoxuanduong, lengocuyen, ECategory.ServiceAttitude, ERate.Three, "Satisfactory service. Car was not as clean as expected.", new DateTime(2022, 1, 22));
        static Feedback feedback16 = new Feedback(luuducthuan, dinhtiencuong, ECategory.ServiceAttitude, ERate.Four, "Helpful staff. The rental process was quick and efficient.", new DateTime(2022, 1, 25));
        static Feedback feedback17 = new Feedback(nguyenkieutrang, dinhvanhoa, ECategory.CommitmentInContract, ERate.Four, "Highly reliable service. Car matched the description in the contract.", new DateTime(2022, 1, 28));
        static Feedback feedback18 = new Feedback(lequangninh, nguyenducthinh, ECategory.ServiceAttitude, ERate.Three, "Average service. Car condition could have been better.", new DateTime(2022, 2, 1));
        static Feedback feedback19 = new Feedback(caoxuanduong, voquangvuong, ECategory.ServiceAttitude, ERate.Four, "Responsive customer support. The car was in good condition.", new DateTime(2022, 2, 3));
        static Feedback feedback20 = new Feedback(phananhnguyet, dinhvanhoa, ECategory.CommitmentInContract, ERate.Five, "Smooth rental process and transparent pricing. Will recommend to others.", new DateTime(2022, 2, 6));
