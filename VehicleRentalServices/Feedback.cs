...
namespace VehicleRentalServices
{
    ...
    public class Feedback
	{
        ...
        public Feedback(Renter sender, Person receiver, ECategory eCategory, ERate eRate, string content, DateTime sendDate)
		{
        ...
        public void OutputInformation()
		{
			...
			Console.WriteLine($"To: {this.receiver.FullName}");
