...
{
    public partial class DisplayDriverRegister : Form
    {
        ...
        private void ClickRegister(object sender, EventArgs e)
        {
            if (CheckToRegister())
            {
                ...
                Driver driver = new Driver(textBox1.Text, textBox2.Text, dateTimePicker1.Value, textBox3.Text, dateTimePicker2.Value);
